...
namespace baitap_lon
{
    ...
    public partial class QUANLIKHACHHANG : Form
    {
        ...
        private void DeleteCustomer(int customerId)
        {
            ...
            string connectionString = "Server=LAPTOP-0GVJC0P1;Database=ShoeStoreDB;User Id=sa;Password=duy16632;";
        ...
        {
            // Chấp nhận cả 3 định dạng:
            // - 9 chữ số (như dữ liệu cũ)
            // - 10 chữ số (0987654321)
            // - 11 chữ số (+84987654321)
            string pattern = @"^(\+84|0)?[3|5|7|8|9][0-9]{8,9}$";
            phone = Regex.Replace(phone, @"[\s\-]", ""); // Bỏ khoảng trắng/dấu gạch
